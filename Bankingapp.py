    ...
    def show_menu(self):
        ...
        while True:
            ...
            if option == 'A':
                ...
                return exit_page()  # Call exit_page directly, might not be a thing tbh in the website release
            else:
                print("Invalid option. Only A, B, C, D, or E is available") #also wont show up in website, refered to tempCodeRunnerFile.py
